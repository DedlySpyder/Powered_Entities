...
if settings.global then
	function Config.refresh()
		Config.SHOW_RECALCULATE_NAME = "Powered_Entities_30_recalculate_show"
		
		Config.ENABLE_INSERTER = settings.global["Powered_Entities_00_enable_inserter"].value
		Config.ENABLE_SOLAR = settings.global["Powered_Entities_01_enable_solar"].value
		Config.ENABLE_ACCUMULATOR = settings.global["Powered_Entities_02_enable_accumulator"].value
		Config.SHOW_RECALCULATE = settings.global[Config.SHOW_RECALCULATE_NAME].value
		Config.RECALCULATE_BATCH_SIZE = settings.global["Powered_Entities_40_recalculate_batch_size"].value
	end
